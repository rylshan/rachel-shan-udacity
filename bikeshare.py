...
def get_filters():
    ...
    print('\n')
    print_spin('Bikeshare', 6)
    print('-(/)Bikeshare(/)-_______________________')
    print(' Hello! Let\'s explore some US bikeshare data! '.center(50, '='))
...
def load_data(city, month, day):
    ...
    print(" Filters applied : "
          "[ {}, {}, {}] ".format(city, month, day).center(50, '*'))
    print()
...
def trip_duration_stats(df):
    ...
    if 'Trip Duration' in df.columns:
        ...
        # Trip Duration stats:
        # -------------------START--------------------------
        print(' Trip Duration stats '.center(50, '-'))
...
def user_stats(df):
    ...
    print()
    print(' Calculating User Stats '.center(50, '='))
    start_time = time.time()
...
def main():
    while True:
        ...
        if restart.lower() != 'yes':
            print()
            print(' Python Script Terminated '.center(50, '*'))
            print()
            break
